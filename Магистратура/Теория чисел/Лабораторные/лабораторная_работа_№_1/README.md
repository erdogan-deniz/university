...
![FILE DATA](resources/gifs/file_data.gif)

• ввода начальной информации из файла, который создается в оболочке программы
![CREATE FILE](resources/gifs/create_file.gif)

• ввод начальной информации с клавиатуры
![INPUT DATA](resources/gifs/input_data.gif)
...
— в собранной документации (`docs/`, раздел `file_structure`)

• основные функции программы
— в собранной документации (`docs/`, раздел `code_docs`)

• назначение функций, входные и выходные параметры функци
— в собранной документации (`docs/`, раздел `code_docs`)

> Документация собирается локально: `cd docs && make html`. Готовый `_build/`
